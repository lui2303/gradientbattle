...
export function optimizerFactory(optimizerName: string, params: any): Optimizer {
    switch (optimizerName) {
        case optimizationAlgorithmsList[1]:
            return new DummyOptimizer(params.lr, params.objective, params.alpha, params.startingPoint, params.id)
    }

    return new VanillaGD(params.lr, params.objective, params.startingPoint, params.id)
}